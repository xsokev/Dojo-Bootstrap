	...
	lang.extend(query.NodeList, {
		modal: function(option){
			return this.forEach(function(node){
				var options = lang.mixin({}, lang.mixin(modalDefaults, lang.mixin(nodeData.get(node), lang.isObject(option) && option)));
				var data = nodeData.get(node, 'modal', new Modal(node, options));
